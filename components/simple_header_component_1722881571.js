            ...
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-6 mx-auto">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-pink-600 rounded-lg lg:bg-transparent lg:text-pink-300 lg:p-0 dark:text-white hover:bg-pink-500 lg:hover:bg-transparent lg:hover:text-white transition duration-300" aria-current="page">Real-time Ethereum transaction tracking</a></li>
